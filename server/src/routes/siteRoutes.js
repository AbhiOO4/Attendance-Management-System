...
router.patch('/:siteId/remove-employee', authorizeRoles("admin"), siteController.removeEmployee)
...
router.patch('/:siteId', authorizeRoles("admin"), siteController.updateSite)
